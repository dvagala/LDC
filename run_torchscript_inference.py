...
model_names = [
	# 'trained_on_PUIBSDS_16_model_scripted.pt'
	'trained_on_BSDS_with_augmentation_16_model_scripted.pt'
	# 'trained_on_thresholded_127_PUIBSDS_16_model_scripted.pt'
	# 'trained_on_PUIBSDS_without_adding_brightness_to_noise_when_training_16_model_scripted.pt'
	]
...
for model_name in model_names:
	...
	for image_path in input_images:
		...
		cv2.imwrite(os.path.join('/Users/dvagala/School/LDC/torchscript_inference',f'{model_name}-{image_file_name.split(".")[0]}.png'), final_image)
